/**
 * yui.socialshareprivacy.js | 2 Klicks fuer mehr Datenschutz
 *
 ...
 * 
 * @edit	Björn Bartels <bb@p-ad.de>, P.AD. Werbeagentur GmbH (09/2011)
 * 
 */
var socialSharePrivacy = {};
YUI({}).use('dom','node','event','overlay', function(Y) {

	// Dropdown Menu, Primaernavigation
	Y.on("contentready", function () {
		socialSharePrivacy = function(options){
	        var defaults = {
	            'services' : {
	                'facebook' : {
	                    'status'            : 'on',
